...
if( ! class_exists( 'avia_sidebar' ) )
{
	class avia_sidebar
	{
		...
		function template_add_widget_field()
		{
            ...
            echo "\n  <h3>". $this->title ."</h3>";
            echo "\n    <span class='avia_style_wrap'><input type='text' value='' placeholder = '".__('在这里输入新小工具区域名字')."' name='avia-add-widget' /></span>";
            echo "\n    <input class='avia_button' type='submit' value='".__('添加小工具区域')."' />";
            echo "\n    ".$nonce;
            echo "\n  </form>";
            echo "\n</script>\n";
		}
