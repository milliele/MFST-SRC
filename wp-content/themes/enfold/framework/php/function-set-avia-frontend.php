...
if(!function_exists('kriesi_backlink'))
{
	...
	{	
		...
		if($random_number % 3 == 0) $theme_string = " WordPress主题";
		if($random_number % 3 == 1) $theme_string = " WordPress主题";
		if($random_number % 3 == 2) $theme_string = "设计：WordPress主题";
		if(!empty($frontpage_only) && !is_front_page()) $no = "rel='nofollow'";
		
		$link = " - <a {$no} href='http://www.4mudi.com'>{$theme_string}</a>";
