...
//四亩地		const API_URL		=	'https://maps.googleapis.com/maps/api/js';
		...
		static public function api_url( $api_key = '', $callback = '' )
		{
			$args = array();
			$api_src = array(
//四亩地							'source'	=>	av_google_maps::API_URL,
							'version'	=>	av_google_maps::API_VERSION
						);
			
			$api_src = apply_filters( 'avf_google_maps_source', $api_src );
			
//四亩地			$api_url = ! empty( $api_src['source'] ) ? $api_src['source'] : av_google_maps::API_URL;
