...
class avia_wp_import extends WP_Import
{
	...
	public function import_layerslides( $layerslider )
	{
		...
		if( ! $zip ) {
			die("LayerSlider无法下载您选择的幻灯片。请检查LayerSlider - >系统状态的潜在问题。 WP Remote功能可能不可用，或者您的Web托管提供商必须允许外部连接到我们的域。"
			);
		}
		...
		{
			die("LayerSlider无法在您的服务器上保存下载的幻灯片。请检查LayerSlider - >系统状态的潜在问题。 此问题的最常见原因是在/ wp-content / uploads /目录中缺少写入权限。");
