			...
			<li id="menu-item-<?php echo $item_id; ?>" class="<?php echo $itemValue; echo implode(' ', $classes ); ?>">
				<dl class="menu-item-bar">
					<dt class="menu-item-handle">
						...
						<span class="item-controls">
							...
							<span class="item-type item-type-megafied"><?php _e('(大菜单)'); ?></span>
				...
				<div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
					...
					<p class="description description-thin description-label avia_label_desc_on_active">
						...
						<span class='avia_mega_label'><?php _e( '大菜单列标题<span class="avia_supersmall">（如果你不想显示标题，只需输入单横线： "-" )</span>' ); ?></span>
					...
					<!-- ################# avia custom code here ################# -->
						...
						<?php
						$title = '使用描述来创建文本区域。不显示此项目为链接。（注意：不要删除此标签文字，否则，WordPress会删除项目）';
