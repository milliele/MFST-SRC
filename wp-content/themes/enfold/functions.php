...
load_theme_textdomain( 'tgmpa', get_template_directory() . '/lang2956' );//四亩地
//四亩地
/*
...
if(!function_exists('avia_lang_setup'))
{
	...
	{
		$lang = apply_filters('ava_theme_textdomain_path', get_template_directory()  . '/lang2956');//四亩地
...
$avia_config['selectableImgSize'] = array(
	'square' 				=> __('正方形','avia_framework'),
	'featured'  			=> __('精选细','avia_framework'),
	'featured_large'  		=> __('精选大','avia_framework'),
	'portfolio' 			=> __('作品','avia_framework'),
	'gallery' 				=> __('相册','avia_framework'),
	'entry_with_sidebar' 	=> __('条目带侧边栏','avia_framework'),
	'entry_without_sidebar'	=> __('条目无侧边栏','avia_framework'),
	'extra_large' 			=> __('全屏栏目/幻灯片','avia_framework'),
 ...
 */
 ...
 $avia_config['font_icons'] = apply_filters('avf_default_icons', array(
	...
	'baidu' 		=> array( 'font' =>'simudi', 'icon' => 'ue900'),
	'weibo' 		=> array( 'font' =>'simudi', 'icon' => 'ue902'),
	'weixin' 		=> array( 'font' =>'simudi', 'icon' => 'ue901'),
	'qq' 	    	=> array( 'font' =>'simudi', 'icon' => 'ue904'),
	'renren' 		=> array( 'font' =>'simudi', 'icon' => 'ue903'),
	'tweibo' 		=> array( 'font' =>'simudi', 'icon' => 'ue905'),	
	'qqzone' 		=> array( 'font' =>'simudi', 'icon' => 'ue906'),
	'sougou' 		=> array( 'font' =>'simudi', 'icon' => 'ue907'),	
	'kaixin' 		=> array( 'font' =>'simudi', 'icon' => 'ue908'),
	'douban' 		=> array( 'font' =>'simudi', 'icon' => 'ue909'),
	'huaban' 		=> array( 'font' =>'simudi', 'icon' => 'ue910'),			
	//woocomemrce    
...
if(!function_exists('avia_nav_menus'))
{
	...
	$avia_config['nav_menus'] = array(	'avia' => array('html' => __('Main Menu', 'avia_framework')),
									    ...
									    // HLM CHANGED BEGINS
                                        'avia4' => array('html' => __('English Main Menu', 'avia_framework'))
                                        // HLM CHANGED ENDS
									);
