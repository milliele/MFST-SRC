...
if(!class_exists('avia_social_share_links'))
{
	...
	'weibo' 	=> array("encode"=>true, "encode_urls"=>false, "pattern" => "http://www.jiathis.com/send/?webid=tsina&url=[permalink]&amp;title=[title]" , 'label' => '分享到微博'),
	'weixin' 	=> array("encode"=>true, "encode_urls"=>false, "pattern" => "http://www.jiathis.com/send/?webid=weixin&url=[permalink]&amp;title=[title]"  , 'label' => '分享到微信'),
	'renren' 	=> array("encode"=>true, "encode_urls"=>false, "pattern" => "http://www.jiathis.com/send/?webid=renren&url=[permalink]&amp;title=[title]"  , 'label' => '分享到人人'),
    'qqzone'    => array("encode"=>true, "encode_urls"=>false, "pattern" => "http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=[permalink]&amp;title=[title]"  , 'label' => '分享到QQ空间'),
	'qq'        => array("encode"=>true, "encode_urls"=>false, "pattern" => "http://connect.qq.com/widget/shareqq/index.html?url=[permalink]&amp;title=[title]"  , 'label' => '分享给QQ好友'),
	'kaixin'    => array("encode"=>true, "encode_urls"=>false, "pattern" => "http://www.jiathis.com/send/?webid=kaixin001&url=[permalink]&amp;title=[title]"  , 'label' => '分享到开心网'),
	'douban'    => array("encode"=>true, "encode_urls"=>false, "pattern" => "http://www.jiathis.com/send/?webid=douban&url=[permalink]&amp;title=[title]"  , 'label' => '分享到豆瓣'),
	'huaban'    => array("encode"=>true, "encode_urls"=>false, "pattern" => "http://www.jiathis.com/send/?webid=huaban&url=[permalink]&amp;title=[title]"  , 'label' => '分享到花瓣'),
			);
