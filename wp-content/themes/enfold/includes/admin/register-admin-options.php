<?php
global $avia_config;
load_theme_textdomain( 'avia_framework', get_template_directory() . '/lang2956' );//四亩地
					...
					<div class='av-header-area-preview av-header-area-preview-menu-only' >
						...
						<div id='av-menu-overlay'>					
							<div id='av-menu-overlay-scroll'>
									...
									<span class='av-overlay-menu-item'>首页</span>
									<span class='av-overlay-menu-item'>关于</span>
									<span class='av-overlay-menu-item av-overlay-menu-item-sub'>- 团队</span>
									<span class='av-overlay-menu-item av-overlay-menu-item-sub'>- 历史</span>
									<span class='av-overlay-menu-item'>联系</span>
								</div>
							</div>
						</div>
						...
						<div id='pr-stretch-wrap' >
								...
								<div id='pr-phone-wrap' >
									<div id='pr-social-wrap' >
										<div id='pr-seconary-menu-wrap' >
											<div id='pr-menu-2nd'>{$iconSpan}<span class='pr-secondary-items'>登录 | 注册 | 等</span><span class='pr-phone-items'>电话： 555-4432</span></div>
											<div id='avia_header_preview' >
												<div id='pr-main-area' >
													...
													<span id='pr-menu-inner'><span class='pr-menu-single pr-menu-single-first'>首页</span><span class='pr-menu-single'>关于</span><span class='pr-menu-single'>联系</span></span> <img id='search_icon' src='".AVIA_BASE_URL."images/layout/search.png'  alt='' />
							...
							<div id='pr-content-area'> 内容 / 幻灯片 / 等 
							<div class='inner-content'><p>和很多知名品牌一样，雪铁龙(Citroën)这个品牌也是取自创始人安德烈·雪铁龙(André Citroën)的家族姓氏。安德烈从小痴迷工业和技术，科学院毕业后成功研发了传动效率更高、噪音更小的人形齿轮，并申请了专利，后于1915年成功创立雪铁龙公司，今天雪铁龙的车标就是从那时的人字形齿轮的形象演化而来。</p>
							
							<p>和很多知名品牌一样，雪铁龙(Citroën)这个品牌也是取自创始人安德烈·雪铁龙(André Citroën)的家族姓氏。安德烈从小痴迷工业和技术，科学院毕业后成功研发了传动效率更高、噪音更小的人形齿轮，并申请了专利，后于1915年成功创立雪铁龙公司，今天雪铁龙的车标就是从那时的人字形齿轮的形象演化而来。</p>
...
$avia_elements[] =	array(	"name" => __("Advanced color and styling options",'avia_framework'),
							"desc" => __("您可以编辑更多和更高级的颜色和样式选项，以覆盖/滑出菜单项，在").
						...
						<div class='avprev-layout-container-inner'>
							...
							<div class='avprev-layout-content-container'>
								<div class='avprev-layout-slider'>
									<strong>全宽区域（例如：全宽幻灯片）</strong>
								</div>
							
								<div class='avprev-layout-container-sizer'>
									<div class='avprev-layout-content av-cell'><strong>内容区域</strong><p>这是内容区域。内容区域可以放博客项目、页面、组合等等。</p></div>
									<div class='avprev-layout-sidebar av-cell'><strong>侧边栏</strong><p>此区域可以放你的侧边栏小工具</p>
									</div>
								</div>
							</div>
					...
					<!--<small class='text_small_outside'>Next Event: in 10 hours 5 minutes.</small>-->
						...
						<div class='live-header_color border'>
							<div class='av_header_block_1'>
								<h3 class='heading webfont_google_webfont'>Logo区域标题</h3>
    							<span class='text'>激活菜单项目 | </span>
    							<span class='meta'>无效菜单项</span><br/>
    							<a class='a_link' href='#'>自定义文字链接</a>
    							<a class='an_activelink' href='#'>悬停链接</a>
							</div>
							<div class='bg2'>高亮背景 + 边框颜色</div>
						</div>
						...
						<div class='live-main_color border avia_half'>
							<h3 class='webfont_google_webfont main_h3 heading'>主要内容标题</h3>
								<p class='content_p'>这是默认内容带默认标题。字体颜色、标题和链接颜色可以在下面选择。 <br/>
									<a class='a_link' href='#'>一个链接</a>
									<a class='an_activelink' href='#'>一个悬停链接</a>
									<span class='meta'>次要字体</span>
						...
						<div class='live-alternate_color border avia_half avia_half_2'>
								<h3 class='webfont_google_webfont main_h3 heading'>交替内容区域</h3>
								<p class='content_p'>这是交替内容带默认标题。字体颜色、标题和链接颜色可以在下面选择。 <br/>
									<a class='a_link' href='#'>一个链接</a>
									<a class='an_activelink' href='#'>一个悬停链接</a>
									<span class='meta'>次级字体</span>
						...
						<div class='live-footer_color border'>
							<h3 class='webfont_google_webfont heading'>演示标题 (页脚)</h3>
							<p>这是页脚背景文字</p>
							<a class='a_link' href='#'>链接 | 链接 2</a>
							<span class='meta'> | 次级字体</span>

						</div>

						<div class='live-socket_color border'>接口文字 <a class='a_link' href='#'>链接 | 链接 2</a>
													<span class='meta'> | 次级字体</span>
...
$avia_elements[] =	array(	"name" 	=> __("Defines the Font for your body text", 'avia_framework'),
				            ...
				            "subtype" => apply_filters('avf_google_content_font', array( __('Web safe fonts', 'avia_framework') => array(
				            					...
				            					'宋体'=>'宋体',
				            					'仿宋'=>'仿宋',
				            					'新宋体'=>'"新宋体",-"Lucida-Grande",-"Lucida-Sans-Unicode-websave"'),
...
$avia_elements[] =	array(
					...
					<div class='av-header-area-preview' >
								...
								<div id='pr-phone-wrap' >
									...
									<div id='pr-menu-2nd'>{$iconSpan}<span class='pr-secondary-items'>登录 | 注册 | 等</span><span class='pr-phone-items'>电话：555-4432</span></div>
											<div id='avia_header_preview' >
												...
												<span id='pr-menu-inner'><span class='pr-menu-single pr-menu-single-first'>首页</span><span class='pr-menu-single'>关于</span><span class='pr-menu-single'>联系</span></span> <img id='search_icon' src='".AVIA_IMG_URL."icons/search.png' alt='' />
													<div id='pr-burger-menu'>
														<span class='burger-top'></span>
														<span class='burger-mid'></span>
														<span class='burger-low'></span>
						...
						<div id='pr-breadcrumb'>一些标题<span class='some-breadcrumb'>首页  &#187; 管理  &#187; 标题 </span></div>
						<div id='pr-content-area'> 内容 / 幻灯片 / 等 
						<div class='inner-content'>这里是一些示例文字，只是演示用的文字。四亩地是一个非常专业的wordpress汉化主题网站，需要最完美的wordpress主题，请访问http://www.4mudi.com</div>
							</div>
						</div>
					</div>
					",
