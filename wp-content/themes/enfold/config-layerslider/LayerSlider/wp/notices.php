	...
	<img src="<?php echo LS_ROOT_URL.'/static/admin/img/ls_80x80.png' ?>" alt="LayerSlider icon">
		...
		<p>
			<?php echo sprintf(
				...
				'</a>')
			?>
			<a href="<?php echo wp_nonce_url('?page=layerslider&action=hide-support-notice', 'hide-support-notice') ?>" class="button">隐藏此信息</a>
		</p>
	<div class="clear"></div>
</div>
...
<!--四亩地			<div class="update-message notice inline notice-warning notice-alt">
				<p>
					<?php
//四亩地						printf(__('You need to authorize this site in order to get upgrades or support for this plugin. %sPurchase a license%s or %senter an existing purchase code%s.', 'installer'),
//四亩地							'<a href="http://codecanyon.net/item/layerslider-responsive-wordpress-slider-plugin-/1362246" target="_blank">', '</a>', '<a href="'.admin_url('admin.php?page=layerslider').'">', '</a>');
					?>
				</p>  
			</div> 四亩地-->
		</td>
