...
// Attributes
		...
		'fontWeight' => array(
			...
			'keys' => 'font-weight',
			'tooltip' => __('设置字体粗体。 请注意，并非每种字体都支持所有列出的变体，因此某些设置可能具有相同的结果。', ''),
			'options' => array(
		...
		'fontStyle' => array(
			...
			'keys' => 'font-style',
			'tooltip' => __('斜体是您选择的字体的自动生成的斜体版本，并且即使没有可用的斜体字体变体，也可以强制平滑。 但是，您应该尽可能使用常规斜体选项。 使用Google字体时，请仔细检查以加载斜体字体变体。', ''),
			'options' => array(
				'unset' => __('Inherit from theme', 'LayerSlider'),
				'normal' => __('Normal', 'LayerSlider'),
		...
		'wordWrap' => array(
			...
			'name' => 'Word-wrap',
			'keys' => 'wordwrap',
			'tooltip' => '如果您的文本内容不适合一行，请启用此选项以允许换行。根据预设，层会根据文字长度自动调整大小。如果您设置了自定义尺寸，建议在大多数情况下启用此选项。',
			'props' => array(
				'meta' => true
			)
		),
