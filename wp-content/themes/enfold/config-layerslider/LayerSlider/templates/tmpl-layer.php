			...
			<div class="ls-post-section ls-hidden">
				<div class="ls-posts-configured">
					<ul class="ls-post-placeholders clearfix">
						...
						<li data-placeholder="<a href=&quot;[post-url]&quot;>阅读更多</a>"><span>[link]</span></li>
					...
					<div class="table-holder">
						<table>
							<tbody>
								...
								<?php
								$fontList = array(
									array('name' => '微软雅黑', 'font' => true),
									array('name' => '黑体', 'font' => true),
									array('name' => '楷体', 'font' => true),
									array('name' => '宋体', 'value' => "'宋体'", 'font' => true),
									array('name' => '仿宋', 'font' => true),
