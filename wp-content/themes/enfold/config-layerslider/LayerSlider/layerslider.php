<?php
load_theme_textdomain( 'LayerSlider', get_template_directory() . '/config-layerslider/LayerSlider/locales/' );//四亩地
/*
Plugin Name: LayerSlider WP
Plugin URI: https://codecanyon.net/item/layerslider-responsive-wordpress-slider-plugin-/1362246
Description: LayerSlider是一个高级自适应幻灯片插件，拥有视差和超过200种2D和3D过渡效果。更多WordPress汉化主题、主题升级、问题咨询请访问：<strong><a href="http://www.4mudi.com">http://www.4mudi.com</a></strong>或者光临<a href="http://wordpresszhuti.taobao.com">四亩地淘宝店</a>
Version: 6.6.8
Author: 四亩地
...
if( defined('LS_PLUGIN_VERSION') || isset($GLOBALS['lsPluginPath']) ) {
	die('错误：看起来您已经安装了一个LayerSlider实例。 WordPress无法同时激活和处理两个实例，您需要首先删除旧版本。');
}
...
function layerslider_plugins_loaded() {
	load_plugin_textdomain('LayerSlider', false, LS_PLUGIN_SLUG . '/locales9215/' );
}
