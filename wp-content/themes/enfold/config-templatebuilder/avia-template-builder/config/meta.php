...
//HLM
$post_types = apply_filters("drop_before_add_addtion",get_post_types_by_support(array('thumbnail','editor')));


$boxes = array(
	
    array( 'title' =>$av_default_title, 'id'=>'avia_builder', 'page'=>$post_types, 'context'=>'normal', 'priority'=>'high', 'expandable'=>true ),//HLM
	array( 'title' =>__('Enfold Shortcode Parser','avia_framework' ), 'id'=>'avia_sc_parser', 'page'=>$post_types, 'context'=>'normal', 'priority'=>'high', 'expandable'=>false ),//HLM
    array( 'title' =>__('Layout','avia_framework' ), 'id'=>'layout', 'page'=>$post_types, 'context'=>'side', 'priority'=>'low'),//四亩地//HLM
	//四亩地
...
$elements = array(
    ...
    array(
        ...
        "subtype" => AviaHelper::get_registered_sidebars(array('默认侧边栏' => ""), array('显示到所有位置'))
        ...
        array(
            ...
            "slug"  => "layout",
            "name"  => __("Choose Main Menu",'avia_framework'),
            "desc"  => __("Choose the Main Menu to show.",'avia_framework'),
            "id"    => "main_menu_choice",
            "type"  => "select",
            "std"   => "",
            "class" => "avia-style",
            "subtype" => array( __("Chinese",'avia_framework') => 'chinese',
                __('English','avia_framework') =>'english',
            )
        ),
        // HLM CHANGED ENDS
